package PPI::Future::Structure::When;

=pod

=head1 NAME

PPI::Future::Structure::When - Circular braces for a when statement
...
C<PPI::Future::Structure::When> is the class used for circular braces that
contain the thing to be matched in a when statement.

=head1 METHODS

C<PPI::Future::Structure::When> has no methods beyond those provided by the

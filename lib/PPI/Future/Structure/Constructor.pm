package PPI::Future::Structure::Constructor;

=pod

=head1 NAME

PPI::Future::Structure::Constructor - Anonymous hash or array constructor
...
C<PPI::Future::Structure::Constructor> is the class used for anonymous C<ARRAY>
reference of C<HASH> reference constructors.

=head1 METHODS

C<PPI::Future::Structure::Constructor> has no methods beyond those provided by

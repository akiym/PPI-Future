package PPI::Future::Structure::Unknown;

=pod

=head1 NAME

PPI::Future::Structure::Unknown - An unknown or unresolved brace structure
...
C<PPI::Future::Structure::Unknown> is class for braces whose type is unknown, or
temporarily unknown.
...
A C<PPI::Future::Structure::Unknown> object should not B<ever> make it out of the
...
C<PPI::Future::Structure::Unknown> has no methods beyond those provided by the

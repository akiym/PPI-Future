package PPI::Future::Statement::Unknown;

=pod

=head1 NAME

PPI::Future::Statement::Unknown - An unknown or transient statement
...
The C<PPI::Future::Statement::Unknown> class is used primarily during the lexing
...
allowing it to get through unresolved) a bug in L<PPI::Future::Lexer>.

=head1 METHODS

C<PPI::Future::Statement::Unknown> has no additional methods beyond the

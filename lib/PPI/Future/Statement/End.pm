package PPI::Future::Statement::End;

=pod

=head1 NAME

PPI::Future::Statement::End - Content after the __END__ of a module
...
=head1 SYNOPSIS
  ...
  This is part of a PPI::Future::Statement::End statement
  ...
  This is another PPI::Future::Statement::End statement
...
C<PPI::Future::Statement::End> is a utility class designed to serve as a contained
...
with L<PPI::Future::Token::Pod> tokens.

=head1 METHODS

C<PPI::Future::Statement::End> has no additional methods beyond the default ones

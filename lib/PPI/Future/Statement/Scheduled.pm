package PPI::Future::Statement::Scheduled;

=pod

=head1 NAME

PPI::Future::Statement::Scheduled - A scheduled code block

=head1 INHERITANCE

  PPI::Future::Statement::Scheduled
  isa PPI::Future::Statement::Sub
...
our @ISA = "PPI::Future::Statement::Sub";

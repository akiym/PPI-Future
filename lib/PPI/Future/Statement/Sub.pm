package PPI::Future::Statement::Sub;

=pod

=head1 NAME

PPI::Future::Statement::Sub - Subroutine declaration
...
(which are part of L<PPI::Future::Statement::Scheduled>) all subroutine declarations
are lexed as a PPI::Future::Statement::Sub object.
...
C<PPI::Future::Statement::Sub> has a number of methods in addition to the standard
...
#####################################################################
# PPI::Future::Statement::Sub Methods
...
sub name {
	...
	return $token->content
	  if defined $token and $token->isa('PPI::Future::Token::Word');
...
It is returned in the same format as L<PPI::Future::Token::Prototype/prototype>,
...
sub prototype {
	...
	my $Prototype = List::Util::first {
		_INSTANCE($_, 'PPI::Future::Token::Prototype')
	} $self->children;
...
With its name and implementation shared with L<PPI::Future::Statement::Scheduled>,
...
sub block {
	...
	$lastchild->isa('PPI::Future::Structure::Block') and $lastchild;
}
...
defined as L<PPI::Future::Statement::Scheduled> objects, not subroutines.
...
sub reserved {
	...
	# - numbers; we allow them by PPI::Future tradition.
	$name eq uc $name;
}

package PPI::Future::Document::File;

=pod

=head1 NAME

PPI::Future::Document::File - A Perl Document located in a specific file

=head1 DESCRIPTION

B<WARNING: This class is experimental, and may change without notice>

B<PPI::Future::Document::File> provides a L<PPI::Future::Document> subclass that represents
...
=head2 new
  ...
  my $file = PPI::Future::Document::File->new( 'Module.pm' );
...
"anonymous" PPI::Future::Document::File object, not can you create an empty one.

Returns a new PPI::Future::Document::File object, or C<undef> on error.
...
sub new {
	...
	if ( _INSTANCE($self, 'PPI::Future::Document') ) {
		bless $self, 'PPI::Future::Document::File';
	} else {
		die "PPI::Future::Document::File SUPER call returned an object of the wrong type";
	}
...
The C<save> method works similarly to the one in the parent L<PPI::Future::Document>

package PPI::Future::Normal;

=pod

=head1 NAME

PPI::Future::Normal - Normalize Perl Documents

=head2 DESCRIPTION

Perl Documents, as created by PPI::Future, are typically filled with all sorts of
...
PPI::Future::Normal attempts to resolve this by providing a variety of mechanisms
	...
	while ( @_ ) {
		...
		SCOPE: {
			...
			defined $function and defined &{"$function"}
				or Carp::croak("Bad function name provided to PPI::Future::Normal");
		}
		...
		defined $layer and $layer =~ /^(?:1|2)$/
			or Carp::croak("Bad layer provided to PPI::Future::Normal");
...
=head2 new
  ...
  my $level_1 = PPI::Future::Normal->new;
  my $level_2 = PPI::Future::Normal->new(2);
...
L<PPI::Future::Document> (object, SCALAR ref, filename), loads it and
...
sub process {
	...
	# PPI::Future::Normal objects are reusable, but not re-entrant
	...
	my $Normalized = PPI::Future::Document::Normalized->new(
...
to the 0.900+ API of PPI::Future only implements Layer 1 and 2 at this time.

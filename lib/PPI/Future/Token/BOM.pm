package PPI::Future::Token::BOM;

=pod

=head1 NAME

PPI::Future::Token::BOM - Tokens representing Unicode byte order marks

=head1 INHERITANCE

  PPI::Future::Token::BOM
...
be treated as L<PPI::Future::Token::Whitespace>.  We recognize the byte order
...
Note that as of this writing, PPI::Future only has support for UTF-8
...
sub __TOKENIZER__on_line_start {
	...
	$t->{class} = 'PPI::Future::Token::Whitespace';

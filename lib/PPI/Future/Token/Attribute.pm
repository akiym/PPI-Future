package PPI::Future::Token::Attribute;

=pod

=head1 NAME

PPI::Future::Token::Attribute - A token for a subroutine attribute
...
A C<PPI::Future::Token::Attribute> token represents the entire of the attribute,
...
#####################################################################
# PPI::Future::Token::Attribute Methods

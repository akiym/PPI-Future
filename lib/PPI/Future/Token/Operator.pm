package PPI::Future::Token::Operator;

=pod

=head1 NAME

PPI::Future::Token::Operator - Token class for operators
...
All operators in PPI::Future are created as C<PPI::Future::Token::Operator> objects,
including the ones that may superficially look like a L<PPI::Future::Token::Word>
object.
...
use PPI::Future::Singletons '%OPERATOR';

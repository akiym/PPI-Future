package PPI::Future::Token::Quote::Double;

=pod

=head1 NAME

PPI::Future::Token::Quote::Double - A standard "double quote" token
...
A C<PPI::Future::Token::Quote::Double> object represents a double-quoted
interpolating string.

The string is treated as a single entity, L<PPI::Future> will not try to
understand what is in the string during the parsing process.

=head1 METHODS

There are several methods available for C<PPI::Future::Token::Quote::Double>, beyond
...
#####################################################################
# PPI::Future::Token::Quote::Double Methods
...
L<PPI::Future::Token::Quote::Single> package.
...
sub simplify {
	...
	my $self = _INSTANCE(shift, 'PPI::Future::Token::Quote::Double') or return undef;
	...
	$self->{content} = "'$value'";
	bless $self, 'PPI::Future::Token::Quote::Single';
}

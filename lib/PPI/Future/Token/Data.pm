package PPI::Future::Token::Data;

=pod

=head1 NAME

PPI::Future::Token::Data - The actual data in the __DATA__ section of a file
...
The C<PPI::Future::Token::Data> class is used to represent the actual data inside
a file's C<__DATA__> section.

One C<PPI::Future::Token::Data> object is used to represent the entire of the data,
primarily so that it can provide a convenient handle directly to the data.

=head1 METHODS

C<PPI::Future::Token::Data> provides one method in addition to those provided by
our parent L<PPI::Future::Token> and L<PPI::Future::Element> classes.

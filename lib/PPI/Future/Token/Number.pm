package PPI::Future::Token::Number;

=pod

=head1 NAME

PPI::Future::Token::Number - Token class for a number
...
The C<PPI::Future::Token::Number> class is used for tokens that represent numbers,
...
Perl, but is allowed in PPI::Future:

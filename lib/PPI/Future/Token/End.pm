package PPI::Future::Token::End;

=pod

=head1 NAME

PPI::Future::Token::End - Completely useless content after the __END__ tag
...
If you've read L<PPI::Future::Token::Whitespace>, you should understand by now
the concept of documents "floating in a sea of PPI::Future::Token::Whitespace".
...
That's fine. PPI::Future likes POD. Any POD after the __END__ tag is parsed
into valid L<PPI::Future::Token::Pod> tags as normal. B<This> class, on the
...
This class has no method beyond what is provided by its L<PPI::Future::Token> and
L<PPI::Future::Element> parent classes.
...
### XS -> PPI::Future/XS.xs:_PPI::Future_Token_End__significant 0.900+
sub significant() { '' }

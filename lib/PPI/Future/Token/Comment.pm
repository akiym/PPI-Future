package PPI::Future::Token::Comment;

=pod

=head1 NAME

PPI::Future::Token::Comment - A comment in Perl source code
...
=head1 SYNOPSIS
  ...
  # This is a PPI::Future::Token::Comment
...
In PPI::Future, comments are represented by C<PPI::Future::Token::Comment> objects.
...
of the one C<PPI::Future::Token::Comment> object.
...
L<PPI::Future::Token::Whitespace> token.
...
parent L<PPI::Future::Token> and L<PPI::Future::Element> classes.
...
### XS -> PPI::Future/XS.xs:_PPI::Future_Token_Comment__significant 0.900+
sub significant() { '' }
...
The C<line> accessor returns true if the C<PPI::Future::Token::Comment> is a

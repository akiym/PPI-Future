package PPI::Future::Token::_QuoteEngine;

=pod

=head1 NAME

PPI::Future::Token::_QuoteEngine - The PPI::Future Quote Engine

=head1 DESCRIPTION

The C<PPI::Future::Token::_QuoteEngine> package is designed hold functionality
for processing quotes and quote like operators, including regexes.
These have special requirements in parsing.

The C<PPI::Future::Token::_QuoteEngine> package itself provides various parsing
methods, which the L<PPI::Future::Token::Quote>, L<PPI::Future::Token::QuoteLike> and
L<PPI::Future::Token::Regexp> can inherit from. In this sense, it serves
as a base class.

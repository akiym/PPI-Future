package PPI::Future::Token::Regexp;

=pod

=head1 NAME

PPI::Future::Token::Regexp - Regular expression abstract base class
...
The C<PPI::Future::Token::Regexp> class is never instantiated, and simply
provides a common abstract base class for the three regular expression
classes. These being:

=over 2

=item m// - L<PPI::Future::Token::Regexp::Match>

=item s/// - L<PPI::Future::Token::Regexp::Substitute>

=item tr/// - L<PPI::Future::Token::Regexp::Transliterate>
...
B<not> a regular expression (which PPI::Future takes to mean something that
...
#####################################################################
# PPI::Future::Token::Regexp Methods

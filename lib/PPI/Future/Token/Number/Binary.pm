package PPI::Future::Token::Number::Binary;

=pod

=head1 NAME

PPI::Future::Token::Number::Binary - Token class for a binary number
...
The C<PPI::Future::Token::Number::Binary> class is used for tokens that

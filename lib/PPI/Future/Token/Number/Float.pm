package PPI::Future::Token::Number::Float;

=pod

=head1 NAME

PPI::Future::Token::Number::Float - Token class for a floating-point number
...
The C<PPI::Future::Token::Number::Float> class is used for tokens that
...
PPI::Future::Token::Number::Exp class.

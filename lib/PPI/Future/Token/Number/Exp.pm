package PPI::Future::Token::Number::Exp;

=pod

=head1 NAME

PPI::Future::Token::Number::Exp - Token class for an exponential notation number
...
=head1 INHERITANCE
  ...
  isa PPI::Future::Token::Number::Float
...
The C<PPI::Future::Token::Number::Exp> class is used for tokens that
...
our @ISA = "PPI::Future::Token::Number::Float";

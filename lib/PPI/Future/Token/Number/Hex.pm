package PPI::Future::Token::Number::Hex;

=pod

=head1 NAME

PPI::Future::Token::Number::Hex - Token class for a binary number
...
The C<PPI::Future::Token::Number::Hex> class is used for tokens that

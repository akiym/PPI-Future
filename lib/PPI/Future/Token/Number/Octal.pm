package PPI::Future::Token::Number::Octal;

=pod

=head1 NAME

PPI::Future::Token::Number::Octal - Token class for a binary number
...
The C<PPI::Future::Token::Number::Octal> class is used for tokens that

package PPI::Future::Token::Number::Version;

=pod

=head1 NAME

PPI::Future::Token::Number::Version - Token class for a byte-packed number
...
=head1 INHERITANCE
  ...
  isa PPI::Future::Token::Number
      isa PPI::Future::Token
          isa PPI::Future::Element

=head1 DESCRIPTION

The C<PPI::Future::Token::Number::Version> class is used for tokens that have
...
our @ISA = "PPI::Future::Token::Number";

package PPI::Future::Token::_QuoteEngine::Simple;

# Simple quote engine

use strict;
use PPI::Future::Token::_QuoteEngine ();

our $VERSION = '1.236';

our @ISA = 'PPI::Future::Token::_QuoteEngine';
...
sub new {
	...
	my $self = PPI::Future::Token::new( $class, $separator ) or return undef;

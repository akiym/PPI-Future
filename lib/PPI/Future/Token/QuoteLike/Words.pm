package PPI::Future::Token::QuoteLike::Words;

=pod

=head1 NAME

PPI::Future::Token::QuoteLike::Words - Word list constructor quote-like operator
...
A C<PPI::Future::Token::QuoteLike::Words> object represents a quote-like operator
